...
14.02.2026 было проведено функциональное тестирование приложения KeyValidator. 
На тестирование затрачено: 0.5 часа

В результате тестирования выявлены следующие дефекты:
* [#1](https://github.com/Rromario/JavaHomework1.2/issues/1)
* [#2](https://github.com/Rromario/JavaHomework1.2/issues/2)
